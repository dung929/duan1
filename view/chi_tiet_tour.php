        ...
        <div class="grid grid-cols-2 gap-8">
            <div>
                ...
                <div class="border-2 rounded-2xl  mt-[20px] bg-pink-300">
                    ...
                    <div class="bg-pink-200 rounded-2xl p-2 font-bold mt-[10px] mb-[10px]">
                        <h2>Mã Tour:1</h2>
                        <h2>Tên Tour: Du lịch Hà Nội - Sapa - Bản Cát Cát - Hàm Rồng dịp Lễ 30/4 từ Hà Nội.</h2>
                        <h2 class="inline-block">Lịch tour:</h2>
                        <input type="date" disabled>
                        <h2>Phương tiện Tour: ô tô,máy bay</h2>
                    </div>
                    <hr>
            ...
            <div>
                <div class="border-2 p-5 bg-neutral-700 rounded-2xl w-[600px]">
                    <form action="">
                        <h2 class="text-[30px] font-bold text-orange-500 mb-[20px]">Giá tour: 1$/người</h2>
                        ...
                        <br>
                        <h2 class="inline-block text-white font-bold mb-[20px]">Phương tiện</h2>
                        <input type="text" value="ô tô, máy bay" disabled class="p-2 rounded-2xl bg-white">
                        <br>
