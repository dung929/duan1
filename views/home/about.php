        ...
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    ...
                    <p class="text-white"> Cái kết viên mãn nhất của tình yêu đó là một đám cưới lãng mạn, hai người ở chung nhà và xây dựng một gia đình mới khiến ai cũng thầm ngưỡng mộ . Chúng tôi sẽ đem lại cho các bạn một kỳ nghỉ tuyệt vời nhất </p>
                    <ul class="list-inline text-white m-0">
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Giá cả hợp lý</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Những địa điểm hấp dẫn</li>
                        <li class="py-2"><i class="fa fa-check text-primary mr-3"></i>Trải nghiệm tuyệt vời</li>
                    </ul>
                </div>
                <div class="col-lg-5">
                        ...
                        <div class="card-body rounded-bottom bg-white p-5">
                            <form>
                                <div class="form-group">
                                    <input type="text" class="form-control p-4" placeholder="Tên " required="required" />
                                </div>
                                <div class="form-group">
