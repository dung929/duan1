        ...
        <div class="container py-5">
            <div class="row">
                        ...
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                ...
                                <div class="bg-white p-4">
                                    ...
                                    <a class="h5 m-0 text-decoration-none" href="">Du lịch biển 2 ngày 1 đêm tại Quy Nhơn - Khánh Hòa</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                <div class="position-relative">
                                    ...
                                    <div class="blog-date">
                                        ...
                                        <small class="text-white text-uppercase">February</small>
                                    </div>
                                </div>
                                <div class="bg-white p-4">
                                    <div class="d-flex mb-2">
                                    ...
                                    <a class="h5 m-0 text-decoration-none" href="">Du lịch 1 ngày chọn gói chùa Tam Chúc - Hà Nam</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                ...
                                <div class="bg-white p-4">
                                    ...
                                    <a class="h5 m-0 text-decoration-none" href="">Du lịch Đà Nẵng 3 ngày 2 đêm cùng gia đình</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                <div class="position-relative">
                                    <img class="img-fluid w-100" src="template_client/img/destination-2.jpg" alt="">
                                    <div class="blog-date">
                                ...
                                <div class="bg-white p-4">
                                    ...
                                    <a class="h5 m-0 text-decoration-none" href="">Du lịch đảo Phú Quốc 4 ngày 3 đêm trùm tour chọn gói</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                <div class="position-relative">
                                    <img class="img-fluid w-100" src="template_client/img/destination-3.jpg" alt="">
                                    <div class="blog-date">
                                ...
                                <div class="bg-white p-4">
                                    ...
                                    <a class="h5 m-0 text-decoration-none" href="">Du lịch Vịnh Hạ Long - Quảng Ninh thuê du thuyền riêng cho tour gia đình</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                <div class="position-relative">
                                    <img class="img-fluid w-100" src="template_client/img/destination-4.jpg" alt="">
                                    <div class="blog-date">
                                ...
                                <div class="bg-white p-4">
                                    ...
                                    <a class="h5 m-0 text-decoration-none" href="">Công viên nước Ocean Park mát mẻ cho một mùa hè nóng bức</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                <div class="position-relative">
                                    <img class="img-fluid w-100" src="template_client/img/package-3.jpg" alt="">
                                    <div class="blog-date">
                                ...
                                <div class="bg-white p-4">
                                    ...
                                    <a class="h5 m-0 text-decoration-none" href="">Du lịch biển Quất Lâm - Nam Định sóng đánh tụt quần</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4 pb-2">
                            <div class="blog-item">
                                <div class="position-relative">
                                    <img class="img-fluid w-100" src="template_client/img/carousel-1.jpg" alt="">
                                    <div class="blog-date">
                                        <h6 class="font-weight-bold mb-n1">08</h6>
                                        <small class="text-white text-uppercase">August</small>
                                    </div>
                                </div>
                                <div class="bg-white p-4">
                                    <div class="d-flex mb-2">
                                    ...
                                    <a class="h5 m-0 text-decoration-none" href="">Du lịch Động Nước Phong Nha Kẻ Bàng - Quảng Bình</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <!-- Tag Cloud -->
                    <div class="mb-5">
                        <h4 class="text-uppercase mb-4" style="letter-spacing: 5px;">Các địa điểm nổi tiếng</h4>
                        <div class="d-flex flex-wrap m-n1">
                            <a href="" class="btn btn-light m-1">Đà Nẵng</a>
                            <a href="" class="btn btn-light m-1">Phú Quốc</a>
                            <a href="" class="btn btn-light m-1">Hạ Long</a>
                            <a href="" class="btn btn-light m-1">Hội An</a>
                            <a href="" class="btn btn-light m-1">Sầm Sơn</a>
                            <a href="" class="btn btn-light m-1">Sapa</a>
                        </div>
                    </div>
                </div>
            </div>
