                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="index.php?url=updateTour" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="category_id" aria-label="Default select example" class="form-control">
                                                        <option selected value="">Chọn danh mục</option>
                                                        <?php foreach ($categories as $key => $value) : ?>
                                                            <option value="<?= $value['id'] ?>"><?= $value['name'] ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                    <?php if (isset($_GET['cate_err'])) : ?>
                                                        <span style="color:red;"><?= $_GET['cate_err'] ?></span>
                                                    <?php endif ?>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Xe:</label>
                                                    <select name="coach" aria-label="Default select example" class="form-control">
                                                        <option selected value="">Chọn phương tiện</option>
                                                        <?php foreach ($coach as $key => $value) : ?>
                                                            <option value="<?= $value['id'] ?>"><?= $value['name'] ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                    <?php if (isset($_GET['coach_err'])) : ?>
                                                        <span style="color:red;"><?= $_GET['coach_err'] ?></span>
                                                    <?php endif ?>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Khach san:</label>
                                                    <select name="hotel" aria-label="Default select example" class="form-control">
                                                        <option selected value="">Chọn khách sạn</option>
                                                        <?php foreach ($hotel as $key => $value) : ?>
                                                            <option value="<?= $value['id'] ?>"><?= $value['name'] ?></option>
                                                        <?php endforeach ?>

                                                    </select>
                                                    <?php if (isset($_GET['hotel_err'])) : ?>
                                                        <span style="color:red;"><?= $_GET['hotel_err'] ?></span>
                                                    <?php endif ?>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Thanh pho:</label>
                                                    <select name="city" aria-label="Default select example" class="form-control">
                                                    ...
                                                    <?php if (isset($_GET['city_err'])) : ?>
                                                        <span style="color:red;"><?= $_GET['city_err'] ?></span>
                                                    <?php endif ?>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Nhan vien huong dan:</label>
                                                    <select name="guide" aria-label="Default select example" class="form-control">
                                                        <option selected value="">Chọn nhân viên hướng dẫn</option>
                                                        <?php foreach ($guide as $key => $value) : ?>
                                                            <option value="<?= $value['id'] ?>"><?= $value['name'] ?></option>
                                                        <?php endforeach ?>

                                                    </select>
                                                    <?php if (isset($_GET['guide_err'])) : ?>
                                                        <span style="color:red;"><?= $_GET['guide_err'] ?></span>
                                                    <?php endif ?>
                                                </div>
